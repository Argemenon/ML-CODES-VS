...
def cycle_theme():
    ...
    next_theme_index = (themes.index(current_theme) + 1) % len(themes)
    Style.theme_use(themes[next_theme_index])
...
entry = ttk.Entry(window, textvariable= entry_text, font= 'Dungeon 25', justify= 'right', width= 15)
entry.pack(pady= 20)
...
btn_theme = ttk.Button(main_frame, text='T' , style= 'small.TButton', width= '4', command= cycle_theme)
